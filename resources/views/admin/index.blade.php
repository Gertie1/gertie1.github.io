...
@section('content')
    ...
    <div id="page-wrapper">
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                <a href="{{ URL::route('rarely') }}" class="alert alert-danger text-center"><i class="fa fa-stop fa-3x"></i> Drugs rarely sold
                </a>
            </div>

            <div class="col-lg-3">
                <a href="{{ URL::route('minimum') }}" class="alert alert-warning text-center"><i class="fa fa-barcode fa-3x"></i> Minimum Stock
                </a>
            </div>

            <div class="col-lg-3">
                <a href="{{ URL::route('none') }}" class="alert alert-danger text-center"><i class="fa fa-warning fa-3x"></i> Drugs out of Stock
                </a>
            </div>
